...
- No opponent (or scripted dummy units that hold position)
...
**Objective**: Defeat the enemy using all learned mechanics.

**Setup**:
- 8x8 board
- 3 red units vs 3 purple dummy units (hold position, don't move)
- Player must use positioning and flanking to defeat stationary defenders
