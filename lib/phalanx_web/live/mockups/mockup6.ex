defmodule PhalanxWeb.Live.Mockups.Mockup6 do
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-zinc-900 to-slate-900 p-8">
      <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="text-center">
          <a href={~p"/mockups"} class="inline-flex items-center gap-2 text-slate-400 hover:text-slate-300 transition-colors">
