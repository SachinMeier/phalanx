defmodule PhalanxWeb.Live.Mockups.Modern.Mockup8 do
    ...
    <div class="min-h-screen bg-gradient-to-br from-stone-950 via-neutral-900 to-stone-950 p-4">
      <div class="max-w-7xl mx-auto space-y-4">
        <div class="flex items-center justify-between">
          ...
          <.link navigate={~p"/mockups/modern"} class="btn btn-sm btn-ghost text-stone-300 hover:text-amber-50">← Back to Mockups</.link>
        </div>
